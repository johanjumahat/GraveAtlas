...
public final class AISystemPrompts {
    ...
    public static final String[] SUGGESTED_PROMPTS = {
        ...
        "Search Kubur Search for graves",
        "Kubur Search cemetery coverage",
        "Translate this headstone inscription",
        "Find name equivalents across languages",
        "Build a family tree from these records",
        "Find family clusters by surname"
    };
}
